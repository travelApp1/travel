<?php
/* Smarty version 3.1.30, created on 2017-07-12 02:54:43
  from "D:\wamp\www\MVC\lvyou\template\index\sousuo.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_59657353c85624_41166253',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '6d072d58e186533913f99a6636da4faa10fa08ad' => 
    array (
      0 => 'D:\\wamp\\www\\MVC\\lvyou\\template\\index\\sousuo.html',
      1 => 1499820882,
      2 => 'file',
    ),
  ),
...
function content_59657353c85624_41166253 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!doctype html>
<html lang="en">
<head>
...
>
    ...
    (function(){
        ...
        function resize() {
            ...
            var size=realWidth/designWidth*fontSize;
...
>
    ...
    inner.style.width=225*lis.length+"px";
    console.log(lis)
    var l=box.offsetWidth;//获取盒子的高度
    var sx;//开始触摸的位置
    var mx;//当前拖拽的距离
    var i=0;//当前是在第几张
    var dir="";//当前拖拽的方向
    ...
    inner.addEventListener("touchstart",function (e) {
        sx=e.changedTouches[0].clientX;//开始时的位置
        inner.style.transition="none";//清空原有的过度属性
...
//        console.log(cha)
        ...
        moveX=-i*125;//向左移动所以为负值
        if(moveX>=0){
            moveX=0;
        }
        var num=lis.length-1;
        var max=inner.offsetWidth-900;
        console.log("max="+max);
        console.log(-num*125);
        if(moveX<=-num*125){
            moveX=-max;
